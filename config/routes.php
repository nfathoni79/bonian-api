...
Router::prefix('v1', function (RouteBuilder $routes) {
    ...
    $routes->prefix('web', function(RouteBuilder $routes) {
        ...
        $routes->connect('/oauth/register/*', ['controller' => 'Oauth', 'action' => 'register', 'disableAuthorization' => true]);
    ...
    $routes->connect('/products/delete-history', ['controller' => 'Products', 'action' => 'deleteHistory']);
    ...
    $routes->connect('/products/share', ['controller' => 'Products', 'action' => 'share']);
