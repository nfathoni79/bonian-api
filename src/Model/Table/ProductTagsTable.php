 ...
 * @method \App\Model\Entity\ProductTag|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ProductTag|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
