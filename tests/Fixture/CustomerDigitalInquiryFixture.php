...
/**
 * CustomerDigitalInquiryFixture
 *
 */
class CustomerDigitalInquiryFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'customer_digital_inquiry';
    ...
    public $fields = [
        ...
        'code' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'status' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null],
        'raw_request' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'customer_number' => ['type' => 'index', 'columns' => ['customer_number'], 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-05-06 09:43:32',
                'modified' => '2019-05-06 09:43:32'
            ],
        ];
        parent::init();
    }
