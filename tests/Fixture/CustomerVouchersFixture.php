...
/**
 * CustomerVouchersFixture
 *
 */
class CustomerVouchersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'customer_id' => ['type' => 'index', 'columns' => ['customer_id', 'voucher_id'], 'length' => []],
        ],
        '_constraints' => [
