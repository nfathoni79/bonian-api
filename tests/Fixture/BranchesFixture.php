...
class BranchesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'provice_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'city_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'subdistrict_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'provice_id' => ['type' => 'index', 'columns' => ['provice_id'], 'length' => []],
            'city_id' => ['type' => 'index', 'columns' => ['city_id'], 'length' => []],
            'subdistrict_id' => ['type' => 'index', 'columns' => ['subdistrict_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'branches_ibfk_1' => ['type' => 'foreign', 'columns' => ['provice_id'], 'references' => ['provinces', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'branches_ibfk_2' => ['type' => 'foreign', 'columns' => ['city_id'], 'references' => ['cities', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'branches_ibfk_3' => ['type' => 'foreign', 'columns' => ['subdistrict_id'], 'references' => ['subdistricts', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'latitude' => 1,
                'longitude' => 1,
                'created' => '2019-03-06 05:12:25',
                'modified' => '2019-03-06 05:12:25'
            ],
        ];
        parent::init();
    }
