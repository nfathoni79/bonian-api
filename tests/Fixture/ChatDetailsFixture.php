 ...
 *
 */
class ChatDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'chat_details_ibfk_1' => ['type' => 'foreign', 'columns' => ['chat_id'], 'references' => ['chats', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'chat_details_ibfk_2' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'chat_details_ibfk_3' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
