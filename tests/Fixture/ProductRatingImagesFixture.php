...
/**
 * ProductRatingImagesFixture
 *
 */
class ProductRatingImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'product_rating_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'product_rating_id' => ['type' => 'index', 'columns' => ['product_rating_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'product_rating_images_ibfk_1' => ['type' => 'foreign', 'columns' => ['product_rating_id'], 'references' => ['product_ratings', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
