...
class AuthCodesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'used' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'code' => 'Lorem ',
                'used' => 1,
                'expired' => '2019-03-06 05:12:24',
                'created' => '2019-03-06 05:12:24',
                'modified' => '2019-03-06 05:12:24'
            ],
        ];
        parent::init();
    }
